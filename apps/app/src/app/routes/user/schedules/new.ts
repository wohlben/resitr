    ...
    <div class="max-w-2xl mx-auto space-y-6">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex items-center gap-4">
          <app-button variant="secondary" link="/user/schedules">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form (submit)="onSubmit($event)" class="space-y-6">
          ...
          <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
            <app-button variant="secondary" link="/user/schedules"> Cancel </app-button>
...
export class CreateWorkoutScheduleComponent {
  ...
  constructor() {
    // Pre-select values if passed in query params
  ...
  isFormValid(): boolean {
    return !!this.formData.workoutTemplateId && this.formData.dayOfWeek >= 0 && this.formData.dayOfWeek <= 6;
  }
  ...
  validateForm(): boolean {
    ...
    if (this.formData.dayOfWeek < 0 || this.formData.dayOfWeek > 6) {
