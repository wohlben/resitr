...
import { Muscle, ExerciseType, TechnicalDifficulty } from '@resitr/api';
...
import { MuscleOptionsPipe } from '../../shared/pipes/muscle-options.pipe';
import { DifficultyOptionsPipe } from '../../shared/pipes/difficulty-options.pipe';
import { TypeOptionsPipe } from '../../shared/pipes/type-options.pipe';

@Component({
  selector: 'app-exercises-filter',
  standalone: true,
  imports: [CommonModule, DropdownComponent, EnumValuesPipe, MuscleOptionsPipe, DifficultyOptionsPipe, TypeOptionsPipe],
  template: `
    <div class="space-y-4">
      <!-- Search Bar -->
      ...
      @if (showAdvancedFilters()) {
        <div class="flex flex-wrap gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <app-dropdown
            label="Type"
            [options]="ExerciseType | enumValues | typeOptions"
          ...
          <app-dropdown
            label="Muscle"
            [options]="Muscle | enumValues | muscleOptions"
          ...
          <app-dropdown
            label="Difficulty"
            [options]="TechnicalDifficulty | enumValues | difficultyOptions"
