    ...
    >
      @for (toast of toastService.toasts$(); track toast.id) {
        <div
          ...
          role="alert"
          [attr.aria-labelledby]="toast.id + '-message'"
        >
          <div class="flex items-start gap-3">
            ...
            <!-- Message -->
            <p [id]="toast.id + '-message'" class="flex-1 text-sm font-medium">
              {{ toast.message }}
            </p>
            ...
            <button
              ...
              class="flex-shrink-0 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 hover:opacity-75"
...
export class ToastComponent {
  ...
  getToastClasses(type: string): string {
    const base =
      'flex items-center p-4 rounded-lg shadow-lg border max-w-sm min-w-[320px]';
